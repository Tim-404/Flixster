...
### Notes
Computer crashed with a CLOCK_WATCHDOG_TIMEOUT code when Android Studio was open, so it started failing during the build stage. This was sort of fixed by updating the Gradle plugins.
